...
public class ClientDAO {
	...
	public List<Client> getClients() {
		Session session = sessionFactory.openSession();
		return HibernateUtil.getSessionFactory().openSession().createQuery("from Client").list();
	}

	public Client getClientById(int id) {
		Client client = (Client) HibernateUtil.getSessionFactory().openSession().get(Client.class, id);
		return client;
	}
}
