...
<tr>
	...
	<td>${client.status}</td>
	<td>
	<a href="${pageContext.request.contextPath}/forwardEdit.jsp?id=${client.id}" >Edit</a><br/>
...
<p><a href="${pageContext.request.contextPath}/forwardAdd.jsp">Add new record</a></p>
	 </form> 
</body>
</html>